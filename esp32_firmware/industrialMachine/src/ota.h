/*
 * ota.h — Remote firmware management for industrialMachine ESP32.
 *
 * Дизайн:
 ...
 *     main loop (USB host, дэлгэц, Firebase) огт блоклогдохгүй.
...
/** Per-cycle tick — main loop-аас тогтмол дуудна (heartbeat + self-test). */
void loop(FirebaseData* fbData, bool firebaseUploadOk);

/** OTA download/install идэвхтэй явагдаж байгаа эсэх. */
bool isUpdating();
